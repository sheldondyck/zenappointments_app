...
r generate model Client first_name:string last_name:string birthday:date email:string telefone_celular:string telefone_home:string telefone_office:string custom_fields:hstore
